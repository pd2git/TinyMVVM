...
* Author：AA
* CreatTime：2023/06/26 21:53:06
* Version: v1.0
* Description：The demo of TinyMVVM view usage for a new view model.
* ==========================================
*/
...
{
    /// <summary>
    /// The demo of TinyMVVM view usage for a new view model.
    /// </summary>
    public class SampleMonoViewForNewVM : MonoView<SampleMonoViewModelNew, SampleMonoModel>
    {
        #region Bind
        ...
        protected override void OnNewViewModelBind(SampleMonoViewModelNew viewModel)
        {
        ...
        protected override void OnOldViewModelUnbind(SampleMonoViewModelNew viewModel)
        {
